...
# --- PAGE CONFIG ---
st.set_page_config(page_title="KOMI Scraper | KOMI Group", page_icon="", layout="comment")
inject_custom_css()
...
st.markdown("""
 <style>
 /* Reset top-level wrappers to remove empty border */
 [data-testid="stVerticalBlock"] > div:not(.tiktok-container),
 [data-testid="stBlock"] > div:not(.tiktok-container),
 [data-testid="stAppViewContainer"] > div:not(.tiktok-container) {
 margin: 0 !important;
 padding: 0 !important;
 ...
 transition: transform αυτο 0.2s ease, box-shadow 0.3s ease !important;
 }
...
with st.form("scraper_form"):
 ...
 "Try adjusting or disabling filters for broader results.</small>", unsafe
 "Try adjusting unsafe_allow_html=True
 )

...
logging.basicConfig(level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s', handlers=[
    logging.FileHandler('tiktok_debug.log'),
...
# --- Retry Decorator ---
@retry(stop_max_attempt_number=5, wait_fixed=5000)  # Increased attempts and delay
...
if submit:
    ...
    with st.spinner("⏳ Scraping data... Please wait."):
        ...
        try:
            ...
            # Process dataframe with memory profiling

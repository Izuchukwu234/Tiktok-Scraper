...
st.markdown("""<div style="display: flex; align-items: center; gap: 10px;">
    ...
    <h1 style="margin: 0;">TikTok Scraper</h1></div>
""", unsafe_allow_html=True)
...
if st.session_state.scraped_df is not None:
    ...
    if download_format == "CSV":
        ...
        st.download_button(" Download JSON", data=df.to_json(orient="records"), file_name="tiktok_data.json", mime="application/json")st.markdown('<div style="height: 50px;"></div>', unsafe_allow_html=True)
